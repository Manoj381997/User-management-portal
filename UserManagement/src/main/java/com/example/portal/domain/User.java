...
public class User implements Serializable {
    ...
    private Date lastLoginDate;         // stores last login Date
    private Date lastLoginDateDisplay;  // Actual last login Date to display
    private Date joinDate;
    private String role;             // ROLE_USER, ROLE_ADMIN
    private String[] authorities;       // CREATE, UPDATE, DELETE
