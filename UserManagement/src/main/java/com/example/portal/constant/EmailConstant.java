...
public class EmailConstant {
    ...
    public static final String USERNAME = "gmanojk85@gmail.com";
    public static final String PASSWORD = "raspberry pie";
    public static final String FROM_EMAIL = "UserPortal";
